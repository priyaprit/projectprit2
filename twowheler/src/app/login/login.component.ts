...
export class LoginComponent implements OnInit {
  ...
  login(u) {
    ...
    if (u.username === 're' && u.password === 're') {
      ...
      this.router.navigateByUrl("role/relation/abcdash");
    }
    ...
    if (u.username === 'ah' && u.password === 'ah') {
      ...
      this.router.navigateByUrl("role/ah/abcdash");
    }
    if (u.username === 'bm' && u.password === 'bm') {
      console.log(u.username,u.password);
      sessionStorage.setItem('role', 'bm');
      this.router.navigateByUrl("role/bm/viewapp");
    }
    if (u.username === 'th' && u.password === 'th') {
      console.log(u.username,u.password);
      sessionStorage.setItem('role', 'th');
      this.router.navigateByUrl("role/th/abcdash");
    }
